...
namespace AkaKraft.Infrastructure.Migrations
{
    ...
    [Migration("20260902113027_AddParkPortalZugangUndKennzeichenAudit")]
    partial class AddParkPortalZugangUndKennzeichenAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.HallenCheck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.MangelAnmerkung", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.ParkKennzeichenAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("KennzeichenNachher")
                        .IsRequired()
                        .HasMaxLength(400)
                    ...
                    b.HasIndex("ParkAccountId", "CreatedAt");

                    b.ToTable("ParkKennzeichenAudits");
                });
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.Umfrage", b =>
                {
                    ...
                    b.Property<DateTime?>("LinkedEventStart")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("LinkedEventTitle")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.Werkzeug", b =>
                {
                    ...
                    b.Property<Guid?>("AnleitungDokumentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AnleitungDokumentId");
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.MangelAnmerkung", b =>
                {
                    ...
                    b.HasOne("AkaKraft.Domain.Entities.Mangel", "Mangel")
                        .WithMany("Anmerkungen")
                        .HasForeignKey("MangelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AkaKraft.Domain.Entities.Werkzeug", b =>
                {
                    b.HasOne("AkaKraft.Domain.Entities.Dokument", "AnleitungDokument")
                        .WithMany()
                        .HasForeignKey("AnleitungDokumentId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("AnleitungDokument");
