...
public interface ICalendarService
{
    ...
    Task<CalendarEventDto> CreateEventAsync(string calendarId, string calendarName, string calendarColor, CreateCalendarEventDto dto, string creatorName, string creatorEmail, Guid? creatorUserId);
    ...
    Task PatchEventCreatorAsync(string calendarId, string eventId, Guid userId, string creatorName, string creatorEmail);
}
